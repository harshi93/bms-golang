...
// we are receiving an object of type Book and we returning an object of type book
...
/* we are returning db object that is of type *gorm.DB and we are returning getBook which is of type Book
 */
